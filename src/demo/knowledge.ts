...
export const SCENARIOS: Scenario[] = [
  {
    ...
    lines: [
      ...
      { id: 'z8', speakerId: 'p-michal', text: 'Zero zmian poza jedną pozycją. Bolek, ile płacimy za Pipedrive?', expect: null },
  ...
  },
  {
    ...
    goal: 'Dyskusja o Beta Testing, potem prośba o punkty, raport w tle, pytanie z internetu i ogólne.',
    ...
    lines: [
      ...
      { id: 'n10', speakerId: 'p-piotr', text: 'Bolek, co to właściwie są e-Doręczenia, w dwóch zdaniach?', expect: null },
